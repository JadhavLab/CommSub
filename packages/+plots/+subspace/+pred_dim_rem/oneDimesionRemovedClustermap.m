...
for K = [inf, 1:3]
    [subspaceDist, rowVar] = sequentialDistanceMatrix(rt, K);
    % ----------------------------
    ...
    saveas(cgFig,fullfile(figureFolder,"subspaceDistance_fromDimRemoval="+K+".svg"))
    saveas(cgFig,fullfile(figureFolder,"subspaceDistance_fromDimRemoval="+K+".png"))
end
