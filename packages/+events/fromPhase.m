function [H, Hvals, Hnanlocs, times] = fromPhases(avgEEGStruct, brainArea, varargin)
 % function [H, Hvals, Hnanlocs, times] = fromPhases(avgEEGStruct, brainArea, varargin)
%
% Captures an eventmatrix of phase 
%
...
for iPattern = 1:nPatterns
    ...
    for index = indices'
        ...
        patternH = [patternH;     eegData(:,PHASE)];
        patternToNan = [patternToNan;  zeros(size(eegData(:,PHASE)))];
