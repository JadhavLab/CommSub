...
%
% Plot COLORNAMES palettes in an RGB/DIN99/OKLab/CIELab/LCh/HSV/XYZ cube. The
% data-cursor gives the colornames, by clicking on the plotted points.
%
% Two vertical colorbars are displayed on the figure's right hand side,
% showing the colormap in sequence, both in color and as grayscale.
%
...
%
	function cncClrSpace()
		...
		switch csp{ids}
			...
			case 'OKLab'
				map = csf.xyz2okl(csf.rgb2xyz(rgb));
			case 'LCh'
