...
colornames('HTML4',rgb,'CIE94:1')
colornames('HTML4',rgb,'CIE94:2') % default.
colornames('HTML4',rgb,'CIE76')
colornames('HTML4',rgb,'DIN99')
colornames('HTML4',rgb,'CMC2:1')
colornames('HTML4',rgb,'CMC1:1')
...
% Add a new color palette to the tool is easy: simply append a suitably-
% named scalar structure array to |COLORNAMES.MAT| (i.e. |SAVE| with the
...
% error, and displays color names that are similar to the input text:
