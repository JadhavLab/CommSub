...
for v = 1:2:numel(varargin)
  switch varargin{v}
    case 'container',container=varargin{v+1};
    case 'spacing'  ,spacing=varargin{v+1};
    case 'xspacing' ,xspacing=varargin{v+1};
    case 'nochecks' ,nochecks=varargin{v+1};
    case 'order'    ,order=varargin{v+1};
    case 'grid'     ,grid=varargin{v+1};
  end
end
