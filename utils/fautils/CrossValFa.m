function [cvLoss, cvLogLike] = CrossValFa(X, q, cvNumFolds, cvOptions, varargin)
% 
...
cvFun = @(Xtrain, Xtest) gather(double(FactorAnalysisTestLogLike(Xtrain, Xtest, q, varargin{:})));
...
if qMax == 0
    ...
    disp('Performing factor analysis with qMax');
    L = FactorAnalysis(S, qMax, varargin{:});
